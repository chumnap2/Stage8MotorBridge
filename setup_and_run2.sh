...
# -------------------------------------------------------------------
# setup_and_run.sh
# Fully automated Stage 8: MotorBridge + F´ components
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 4️⃣ Launch MotorBridgeServer2.jl in background
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 5️⃣ Launch F´ components
# -------------------------------------------------------------------
echo "⚡ Launching Stage 8 F´ components..."
# Example: adjust to your actual F´ component launch commands
...
# -------------------------------------------------------------------
# 6️⃣ Trap Ctrl+C and exit for clean shutdown
# -------------------------------------------------------------------
cleanup() {
